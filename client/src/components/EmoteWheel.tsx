        ...
        {EMOTES.map((emote, i) => {
          ...
          return (
            <button
              ...
              className="absolute w-14 h-14 -ml-7 -mt-7 rounded-full bg-gray-900/90 backdrop-blur border-2 border-gray-700 hover:border-yellow-500 hover:scale-125 active:scale-110 active:border-yellow-500 hover:bg-gray-800 transition-all flex items-center justify-center text-2xl shadow-lg"
              style={{
                left: x,
                top: y,
